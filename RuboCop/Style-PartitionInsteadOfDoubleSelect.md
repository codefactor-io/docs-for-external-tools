Pattern: Consecutive `select` and `reject` calls instead of `partition`
...
* [RuboCop - Style/PartitionInsteadOfDoubleSelect](https://docs.rubocop.org/rubocop/latest/cops_style.html#stylepartitioninsteadofdoubleselect)
